...
void Object3d::LoadTexture(const string& DIRECTORY_PATH, const string& FILENAME)
{
	HRESULT result = S_FALSE;
...
void Object3d::LoadMaterial(const string& DIRECTORY_PATH, const string& FILENAME)
{
	ifstream file;
...
bool Object3d::Initialize()
{
	...
	result = device->CreateCommittedResource(
		...
		&resourceDesc[1], D3D12_RESOURCE_STATE_GENERIC_READ, nullptr,
